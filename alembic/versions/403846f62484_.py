...
Revision ID: 403846f62484
Revises: 
Create Date: 2022-03-23 01:45:15.275351
...
def upgrade():
    ...
    with open(os.path.join(os.path.dirname(__file__), "../data/student.json")) as f:
        student_data = f.read()
